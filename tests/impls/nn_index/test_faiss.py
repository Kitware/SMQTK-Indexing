...
class TestFAISSIndex (unittest.TestCase):
    ...
    def _make_inst(
        ...
        idx2uid_kvs: Optional[KeyValueStore] = None,
        uid2idx_kvs: Optional[KeyValueStore] = None,
        **kwargs: Any
    ...
    def test_init_invalid_nprobe(self) -> None:
        """
    ...
    def test_init_invalid_metric_type_label(self) -> None:
        """
    ...
    def test_init_invlaid_metric_type_int(self) -> None:
        """
    ...
    def test_init_valid_metric_type_label(self) -> None:
        """
    ...
    def test_init_valid_metric_type_integer(self) -> None:
        """
    ...
    def test_configuration_null_persistence(self) -> None:
    ...
    def test_remove_from_index_keyerror_empty_index(self) -> None:
        """
    ...
    def test_remove_from_index_keyerror(self) -> None:
        """
    ...
    def test_nn_non_flat_index(self) -> None:
    ...
    def test_nn_preprocess_index(self) -> None:
    ...
    def test_nn_ivf_nprobe_parametrization(self) -> None:
        """
        ...
        assert hasattr(index._faiss_index, "nprobe")
        ...
        index.build_index(descr_elems)
        assert index._faiss_index is not None
        assert not hasattr(index._faiss_index, "nprobe")
        q_results, q_dists = index.nn(descr_elems[0], n=64)
        assert len(q_results) == 64
